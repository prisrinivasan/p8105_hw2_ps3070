...
The column `rank` was initially populated based on count within each `ethnicity` category. However, some ethnicity values are named differently and were combined above. Because of this, a new rank column was created to show total rankings within each category.