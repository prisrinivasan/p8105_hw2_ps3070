...
First, I will load and tidy the data with the following in mind: \* names of a categorical predictor and the case structure of string variables changed over time \* some rows seem duplicated, so I removed using `distinct()`
